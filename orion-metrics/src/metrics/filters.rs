...
pub(crate) fn init_metrics() {
    ...
    init_observable_counter!(LOCAL_RATE_LIMIT, "filter", "local_rate_limit", "Local rate limit filter invocations");
    init_observable_counter!(USER_RATE_LIMIT, "filter", "user_rate_limit", "User rate limit filter invocations");
}
