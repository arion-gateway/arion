...
pub fn init_metrics(config: &arion_configuration::config::metrics::CustomMetrics) {
        ...
        for metric in metrics {
            match metric {
                CustomMetric::Counter { name, description, header_name: http_header_name, attribute_name } => {
                    ...
                    let _ = global::meter(const_format::concatcp!("arion.", crate::metrics::PREFIX_CUSTOM))
                ...
                CustomMetric::Histogram {
                    ...
                    let otel_histogram =
                        global::meter(const_format::concatcp!("arion.", crate::metrics::PREFIX_CUSTOM))
...
impl CustomMetrics {
    pub fn new(config: &arion_configuration::config::metrics::CustomMetrics) -> Self {
        Self {
