...
async fn test_x_request_id_gen_false_preserve_false_always_false() {
    let (arion, client, mut backend, config_path) = setup(false, false, false).await;
...
async fn test_x_request_id_gen_false_preserve_false_always_true() {
    let (arion, client, mut backend, config_path) = setup(false, false, true).await;
...
async fn test_x_request_id_gen_false_preserve_true_always_false() {
    let (arion, client, mut backend, config_path) = setup(false, true, false).await;
...
async fn test_x_request_id_gen_false_preserve_true_always_true() {
    let (arion, client, mut backend, config_path) = setup(false, true, true).await;
...
async fn test_x_request_id_gen_true_preserve_false_always_false() {
    let (arion, client, mut backend, config_path) = setup(true, false, false).await;
...
async fn test_x_request_id_gen_true_preserve_false_always_true() {
    let (arion, client, mut backend, config_path) = setup(true, false, true).await;
...
async fn test_x_request_id_gen_true_preserve_true_always_false() {
    let (arion, client, mut backend, config_path) = setup(true, true, false).await;
...
async fn test_x_request_id_gen_true_preserve_true_always_true() {
    let (arion, client, mut backend, config_path) = setup(true, true, true).await;
