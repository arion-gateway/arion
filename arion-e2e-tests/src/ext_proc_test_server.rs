...
impl CapturedProcessingRequest {
    pub fn as_request_headers(
        &self,
    ) -> Option<&arion_data_plane_api::envoy_data_plane_api::envoy::service::ext_proc::v3::HttpHeaders> {
    ...
    pub fn as_request_body(
        &self,
    ) -> Option<&arion_data_plane_api::envoy_data_plane_api::envoy::service::ext_proc::v3::HttpBody> {
        match &self.0.request {
