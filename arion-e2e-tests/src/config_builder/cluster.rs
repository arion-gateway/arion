    ...
    fn build_lb_policy_typed_config(policy: LbPolicy) -> Any {
        match policy {
            ...
            LbPolicy::LeastRequest => {
                use arion_data_plane_api::envoy_data_plane_api::envoy::extensions::load_balancing_policies::least_request::v3::LeastRequest;
                Any {
                    type_url:
            ...
            LbPolicy::RingHash => {
                use arion_data_plane_api::envoy_data_plane_api::envoy::extensions::load_balancing_policies::ring_hash::v3::RingHash;
                Any {
            ...
            LbPolicy::Maglev => {
                use arion_data_plane_api::envoy_data_plane_api::envoy::extensions::load_balancing_policies::maglev::v3::Maglev;
                Any {
