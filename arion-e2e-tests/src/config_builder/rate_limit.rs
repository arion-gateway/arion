...
use arion_data_plane_api::envoy_data_plane_api::envoy::extensions::filters::http::local_ratelimit::v3::LocalRateLimit as UserLocalRateLimit;

pub type LocalRateLimit = EnvoyLocalRateLimit;
pub type UserRateLimiter = ArionUserRateLimiter;
...
impl LocalRateLimitBuilder {
    ...
    pub fn status_code(mut self, code: u32) -> Self {
        ...
        self.proto.status = Some(arion_data_plane_api::envoy_data_plane_api::envoy::r#type::v3::HttpStatus { code });
        self
    }
...
impl UserRateLimiterBuilder {
    ...
    #[must_use]
    pub fn build(self) -> ArionUserRateLimiter {
        ArionUserRateLimiter {
            stat_prefix: self.stat_prefix,
            user_id_header_name: self.user_id_header,
            #[allow(clippy::cast_possible_wrap, reason = "HTTP status codes 100-599 always fit in i32")]
            status: Some(arion_data_plane_api::envoy_data_plane_api::envoy::r#type::v3::HttpStatus {
...
impl From<UserRateLimiterBuilder> for ArionUserRateLimiter {
