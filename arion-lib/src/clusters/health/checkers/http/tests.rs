...
struct HttpActionTrace {
    requests: mpsc::UnboundedSender<http::Request<ArionRequestBody>>,
    responses: mpsc::UnboundedReceiver<http::Response<ArionResponseBody>>,
}
...
struct HttpTestFixture {
    inner:
        TestFixture<HttpHealthCheck, MockHttpStack, http::Request<ArionRequestBody>, http::Response<ArionResponseBody>>,
}
...
impl HttpTestFixture {
    ...
    pub async fn request_expected(&mut self, timeout_value: Duration) -> http::Request<ArionRequestBody> {
...
deref!(HttpTestFixture => inner as TestFixture<HttpHealthCheck, MockHttpStack, http::Request<ArionRequestBody>, http::Response<ArionResponseBody>>);
