...
impl Cors {
    pub fn apply_request(&mut self, req: &mut Request<ArionRequestBody>) -> FilterDecision {
    ...
    fn generate_preflight_response(&self, ver: http::Version) -> FilterDecision {
        ...
        // Construct empty body for Arion
...
mod tests {
    ...
    fn mock_req_full(
        ...
        let body = ArionRequestBody::default();
