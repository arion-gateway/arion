...
fn extract_quota(response: &RateLimitResponse) -> Option<(u32, u64)> {
    use arion_data_plane_api::envoy_data_plane_api::envoy::service::ratelimit::v3::rate_limit_response::quota::ExpirationSpecifier;
...
fn proto_timestamp_to_ms(ts: &arion_data_plane_api::envoy_data_plane_api::google::protobuf::Timestamp) -> Option<u64> {
