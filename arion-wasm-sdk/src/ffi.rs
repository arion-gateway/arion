...
extern "C" {
    ...
    pub fn arion_set_custom_metrics(buffer_ptr: *const u8, buffer_len: u32) -> i32;

    /// Set multiple access log operators at once.
    pub fn arion_set_access_log_operators(buffer_ptr: *const u8, buffer_len: u32) -> i32;

    pub fn arion_get_uri(buf_ptr: *mut u8, max_len: u32, written_len_ptr: *mut u32) -> i32;
    pub fn arion_set_uri(buf_ptr: *const u8, buf_len: u32) -> i32;
    pub fn arion_get_status_code(out_status_ptr: *mut u32) -> i32;
    pub fn arion_set_status_code(status_code: u32) -> i32;

    pub fn arion_get_request(buf_ptr: *mut u8, max_len: u32, written_len_ptr: *mut u32) -> i32;
    pub fn arion_set_request(buf_ptr: *const u8, buf_len: u32) -> i32;
    pub fn arion_get_response(buf_ptr: *mut u8, max_len: u32, written_len_ptr: *mut u32) -> i32;
    pub fn arion_set_response(buf_ptr: *const u8, buf_len: u32) -> i32;

    /// Read an HTTP header by name.
    pub fn arion_get_header(
        is_trailer: u32,
        name_ptr: *const u8,
        name_len: u32,
        value_ptr: *mut u8,
    ...
    pub fn arion_get_body(body_ptr: *mut u8, max_len: u32, written_len_ptr: *mut u32) -> i32;

    /// Replace the buffered body.
    pub fn arion_set_body(body_ptr: *const u8, body_len: u32) -> i32;

    /// Dispatch an async HTTP call via the host cluster manager.
    pub fn arion_dispatch_http_call(
        req_ptr: *const u8,
        req_len: u32,
    ...
    pub fn arion_dispatch_grpc_call(
        req_ptr: *const u8,
        req_len: u32,
        resp_ptr_ptr: *mut *mut u8,
        resp_len_ptr: *mut u32,
    ...
    pub fn arion_send_direct_response(resp_ptr: *const u8, resp_len: u32) -> i32;

    /// Log a message via the host's tracing framework.
    pub fn arion_log(level: u32, msg_ptr: *const u8, msg_len: u32) -> i32;

    pub fn arion_get_downstream_metadata(out_ptr_ptr: *mut *mut u8, out_len_ptr: *mut u32) -> i32;

    pub fn arion_get_headers_map(is_trailer: u32, buf_ptr: *mut u8, max_len: u32, written_len_ptr: *mut u32) -> i32;
    pub fn arion_set_headers_map(is_trailer: u32, buf_ptr: *const u8, buf_len: u32) -> i32;

    pub fn arion_set_header(
        is_trailer: u32,
        name_ptr: *const u8,
        name_len: u32,
        value_ptr: *const u8,
    ...
    pub fn arion_remove_header(is_trailer: u32, name_ptr: *const u8, name_len: u32) -> i32;
    pub fn arion_replace_header(
        is_trailer: u32,
        name_ptr: *const u8,
        name_len: u32,
        value_ptr: *const u8,
    ...
    pub fn arion_apply_header_mutations(is_trailer: u32, buf_ptr: *const u8, buf_len: u32) -> i32;

    pub fn arion_set_io_timeout(microseconds: u64) -> i32;
    pub fn arion_clear_io_timeout(remaining_us_ptr: *mut u64) -> i32;
    pub fn arion_sleep(microseconds: u64) -> i32;
