...
typedConfig:
  ...
  codecType: HTTP1"#;
    use arion_data_plane_api::envoy_data_plane_api::envoy::config::listener::v3::Filter;
...
"#;
    ...
    use arion_data_plane_api::envoy_data_plane_api::envoy::config::route::v3::Route;
