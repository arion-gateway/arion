...
impl AggregatedDiscoveryService for MockDiscoveryService {
    ...
    async fn stream_aggregated_resources(
        ...
        _request: tonic::Request<
            tonic::Streaming<
                arion_data_plane_api::envoy_data_plane_api::envoy::service::discovery::v3::DiscoveryRequest,
            >,
        >,
    ...
    async fn delta_aggregated_resources(
        ...
        request: tonic::Request<
            tonic::Streaming<
                arion_data_plane_api::envoy_data_plane_api::envoy::service::discovery::v3::DeltaDiscoveryRequest,
            >,
        >,
...
impl ClusterDiscoveryService for MockDiscoveryService {
    ...
    async fn fetch_clusters(
        ...
        tonic::Response<arion_data_plane_api::envoy_data_plane_api::envoy::service::discovery::v3::DiscoveryResponse>,
        tonic::Status,
    > {
        unimplemented!("not used by proxy");
    }
