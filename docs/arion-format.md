...
Arion-format is a Rust crate designed to format Envoy access logs efficiently. It provides a way to construct log formatters that can be cloned and used to format access log entries without incurring significant performance overhead.
