...
mod envoy_conversions {
    ...
    use arion_data_plane_api::envoy_data_plane_api::envoy::extensions::filters::http::jwt_authn::v3::JwtProvider as EnvoyJwtProvider;
    ...
    // The good news is that we can use the same arion RetryPolicy for both, defaulting few missing fields.
