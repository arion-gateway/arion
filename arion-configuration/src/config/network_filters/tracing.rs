...
use arion_data_plane_api::envoy_data_plane_api::{envoy::config::trace::v3::tracing::http, google::protobuf::Any};

use arion_data_plane_api::envoy_data_plane_api::envoy::config::trace::v3::OpenTelemetryConfig as EnvoyOpenTelemetryConfig;
