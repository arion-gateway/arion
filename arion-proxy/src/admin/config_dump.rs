...
mod config_dump_tests {
    ...
    use super::*;
    use arion_lib::{ConfigurationSenders, ListenerConfigurationChange};
    ...
    async fn config_dump_bootstrap_secrets_redacted() {
        use arion_configuration::config::bootstrap::StaticResources;
        ...
        let admin_state = AdminState {
            ...
            secret_manager: Arc::new(RwLock::new(arion_lib::SecretManager::default())),
    ...
    async fn config_dump_bootstrap() {
        ...
        let bootstrap = Bootstrap {
            admin: Some(arion_configuration::config::bootstrap::Admin {
                                ...
                                virtual_hosts: vec![VirtualHost {
                                    ...
                                    routes: vec![Route {
                                        ...
                                        action: Action::DirectResponse(
                                            arion_configuration::config::network_filters::http_connection_manager::route::DirectResponseAction {
    ...
    async fn config_dump_clusters() {
        ...
        let secret_manager = arion_lib::SecretManager::default();
        let partial_cluster =
            arion_lib::clusters::cluster::PartialClusterType::try_from((Box::new(cluster.clone()), &secret_manager))
                .unwrap();
        let _ = arion_lib::clusters::clusters_manager::add_cluster(partial_cluster).ok();
        let (configuration_senders, handle) = spawn_mock_listener_manager(None);
        let admin_state = AdminState {
            bootstrap: Bootstrap::default(),
            configuration_senders: vec![configuration_senders],
    ...
    async fn config_dump_endpoints() {
        ...
        let partial_cluster =
            arion_lib::clusters::cluster::PartialClusterType::try_from((Box::new(cluster.clone()), &secret_manager))
                .unwrap();
        arion_lib::clusters::clusters_manager::add_cluster(partial_cluster).unwrap();
        let (configuration_senders, handle) = spawn_mock_listener_manager(None);
        let admin_state = AdminState {
            bootstrap: Bootstrap::default(),
            configuration_senders: vec![configuration_senders],
    ...
    async fn config_dump_secrets() {
        use arion_configuration::config::secret::{Secret, TlsCertificate, Type, ValidationContext};
        use smol_str::SmolStr;
        use std::fs;
        let mut secret_manager = arion_lib::SecretManager::new();
        ...
        let tls_secret = Secret {
            ...
            kind: Type::TlsCertificate(
                TlsCertificate::try_from(
                    arion_data_plane_api::envoy_data_plane_api::envoy::extensions::transport_sockets::tls::v3::TlsCertificate {
                        certificate_chain: Some(arion_data_plane_api::envoy_data_plane_api::envoy::config::core::v3::DataSource {
                            specifier: Some(
                        ...
                        private_key: Some(arion_data_plane_api::envoy_data_plane_api::envoy::config::core::v3::DataSource {
                            specifier: Some(
                                arion_data_plane_api::envoy_data_plane_api::envoy::config::core::v3::data_source::Specifier::InlineString(
                                    key_pem,
                                ),
        ...
        let validation_secret = Secret {
            ...
            kind: Type::ValidationContext(
                ValidationContext::try_from(
                    arion_data_plane_api::envoy_data_plane_api::envoy::extensions::transport_sockets::tls::v3::CertificateValidationContext {
                        trusted_ca: Some(arion_data_plane_api::envoy_data_plane_api::envoy::config::core::v3::DataSource {
                            specifier: Some(
                                arion_data_plane_api::envoy_data_plane_api::envoy::config::core::v3::data_source::Specifier::InlineString(
                                    ca_pem.clone(),
                                ),
