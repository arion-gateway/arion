...
use super::super::model::ConstString;
...
impl StringSchema {
    ...
    pub fn email() -> Self {
        Self { format: Some(StringFormat::Email), ..Default::default() }
    }

    /// Create a URI string schema
    pub fn uri() -> Self {
        Self { format: Some(StringFormat::Uri), ..Default::default() }
    }

    /// Create a date string schema
    pub fn date() -> Self {
        Self { format: Some(StringFormat::Date), ..Default::default() }
    }

    /// Create a date-time string schema
    pub fn date_time() -> Self {
        Self { format: Some(StringFormat::DateTime), ..Default::default() }
    }
...
impl Default for NumberSchema {
    fn default() -> Self {
        Self { type_: NumberTypeConst, title: None, description: None, minimum: None, maximum: None }
    }
}
...
impl Default for IntegerSchema {
    fn default() -> Self {
        Self { type_: IntegerTypeConst, title: None, description: None, minimum: None, maximum: None }
    }
}
...
impl Default for BooleanSchema {
    fn default() -> Self {
        Self { type_: BooleanTypeConst, title: None, description: None, default: None }
    }
}
...
impl EnumSchema {
    ...
    pub fn new(values: Vec<String>) -> Self {
        Self { type_: StringTypeConst, enum_values: values, enum_names: None, title: None, description: None }
    }
...
impl ElicitationSchema {
    ...
    pub fn new(properties: BTreeMap<String, PrimitiveSchema>) -> Self {
        Self { type_: ObjectTypeConst, title: None, properties, required: None, description: None }
    }
    ...
    pub fn from_json_schema(schema: super::super::model::JsonObject) -> Result<Self, serde_json::Error> {
...
impl ElicitationSchemaBuilder {
    ...
    pub fn string_property(mut self, name: impl Into<String>, f: impl FnOnce(StringSchema) -> StringSchema) -> Self {
        self.properties.insert(name.into(), PrimitiveSchema::String(f(StringSchema::new())));
        self
    }
    ...
    pub fn required_string_property(
        ...
        let name_str = name.into();
        self.required.push(name_str.clone());
        self.properties.insert(name_str, PrimitiveSchema::String(f(StringSchema::new())));
        self
    }

    /// Add a number property with custom builder
    pub fn number_property(mut self, name: impl Into<String>, f: impl FnOnce(NumberSchema) -> NumberSchema) -> Self {
        self.properties.insert(name.into(), PrimitiveSchema::Number(f(NumberSchema::new())));
        self
    }
    ...
    pub fn required_number_property(
        ...
        let name_str = name.into();
        self.required.push(name_str.clone());
        self.properties.insert(name_str, PrimitiveSchema::Number(f(NumberSchema::new())));
        self
    }

    /// Add an integer property with custom builder
    pub fn integer_property(mut self, name: impl Into<String>, f: impl FnOnce(IntegerSchema) -> IntegerSchema) -> Self {
        self.properties.insert(name.into(), PrimitiveSchema::Integer(f(IntegerSchema::new())));
        self
    }
    ...
    pub fn required_integer_property(
        ...
        let name_str = name.into();
        self.required.push(name_str.clone());
        self.properties.insert(name_str, PrimitiveSchema::Integer(f(IntegerSchema::new())));
        self
    }

    /// Add a boolean property with custom builder
    pub fn bool_property(mut self, name: impl Into<String>, f: impl FnOnce(BooleanSchema) -> BooleanSchema) -> Self {
        self.properties.insert(name.into(), PrimitiveSchema::Boolean(f(BooleanSchema::new())));
        self
    }
    ...
    pub fn required_bool_property(
        ...
        let name_str = name.into();
        self.required.push(name_str.clone());
        self.properties.insert(name_str, PrimitiveSchema::Boolean(f(BooleanSchema::new())));
        self
    }
    ...
    /// Add a required string property with custom builder
    pub fn required_string_with(self, name: impl Into<String>, f: impl FnOnce(StringSchema) -> StringSchema) -> Self {
        self.required_property(name, PrimitiveSchema::String(f(StringSchema::new())))
    }

    /// Add an optional string property with custom builder
    pub fn optional_string_with(self, name: impl Into<String>, f: impl FnOnce(StringSchema) -> StringSchema) -> Self {
    ...
    pub fn required_number(self, name: impl Into<String>, min: f64, max: f64) -> Self {
        self.required_property(name, PrimitiveSchema::Number(NumberSchema::new().range(min, max)))
    }

    /// Add an optional number property with range
    pub fn optional_number(self, name: impl Into<String>, min: f64, max: f64) -> Self {
        self.property(name, PrimitiveSchema::Number(NumberSchema::new().range(min, max)))
    }

    /// Add a required number property with custom builder
    pub fn required_number_with(self, name: impl Into<String>, f: impl FnOnce(NumberSchema) -> NumberSchema) -> Self {
        self.required_property(name, PrimitiveSchema::Number(f(NumberSchema::new())))
    }

    /// Add an optional number property with custom builder
    pub fn optional_number_with(self, name: impl Into<String>, f: impl FnOnce(NumberSchema) -> NumberSchema) -> Self {
    ...
    pub fn required_integer(self, name: impl Into<String>, min: i64, max: i64) -> Self {
        self.required_property(name, PrimitiveSchema::Integer(IntegerSchema::new().range(min, max)))
    }

    /// Add an optional integer property with range
    pub fn optional_integer(self, name: impl Into<String>, min: i64, max: i64) -> Self {
        self.property(name, PrimitiveSchema::Integer(IntegerSchema::new().range(min, max)))
    }
    ...
    pub fn optional_bool(self, name: impl Into<String>, default: bool) -> Self {
        self.property(name, PrimitiveSchema::Boolean(BooleanSchema::new().with_default(default)))
    }

    /// Add a required boolean property with custom builder
    pub fn required_bool_with(self, name: impl Into<String>, f: impl FnOnce(BooleanSchema) -> BooleanSchema) -> Self {
    ...
    pub fn optional_bool_with(self, name: impl Into<String>, f: impl FnOnce(BooleanSchema) -> BooleanSchema) -> Self {
    ...
    pub fn build(self) -> Result<ElicitationSchema, &'static str> {
        ...
        Ok(ElicitationSchema {
            ...
            required: if self.required.is_empty() { None } else { Some(self.required) },
...
mod tests {
    ...
    fn test_number_schema_serialization() {
        let schema = NumberSchema::new().range(0.0, 100.0).description("Percentage");
        let json = serde_json::to_value(&schema).unwrap();
    ...
    fn test_enum_schema_serialization() {
        let schema = EnumSchema::new(vec!["US".to_string(), "UK".to_string()])
            .enum_names(vec!["United States".to_string(), "United Kingdom".to_string()])
            .description("Country code");
        let json = serde_json::to_value(&schema).unwrap();

        assert_eq!(json["type"], "string");
        assert_eq!(json["enum"], json!(["US", "UK"]));
        assert_eq!(json["enumNames"], json!(["United States", "United Kingdom"]));
    ...
    fn test_elicitation_schema_builder_simple() {
        let schema =
            ElicitationSchema::builder().required_email("email").optional_bool("newsletter", false).build().unwrap();
    ...
    fn test_elicitation_schema_builder_complex() {
        let schema = ElicitationSchema::builder()
            ...
            .required_integer("age", 0, 150)
            .optional_bool("newsletter", false)
            .required_enum("country", vec!["US".to_string(), "UK".to_string(), "CA".to_string()])
            .description("User registration")
            .build()
            .unwrap();

        assert_eq!(schema.properties.len(), 4);
        assert_eq!(schema.required, Some(vec!["name".to_string(), "age".to_string(), "country".to_string()]));
        assert_eq!(schema.description.as_deref(), Some("User registration"));
    }

    #[test]
    fn test_elicitation_schema_serialization() {
        let schema = ElicitationSchema::builder().required_string_with("name", |s| s.length(1, 100)).build().unwrap();
